    ...
    return(
        ...
        <div className="2xl:container xl:container lg:container md:container sm:container mx-auto flex justify-between py-11">
          ...
          <div className="flex items-center">
            ...
            {open === false ? (
              <CgMenuRightAlt className="text-lg-5 cursor-pointer" onClick={handleOpenMenu} />
            ) : (
              <AiOutlineClose className="text-white text-lg-5 cursor-pointer" onClick={handleOpenMenu} />
            )}
          </div>
        </div>
      </div>
